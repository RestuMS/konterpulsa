...
<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <a href="{{ route('expenses.index') }}" class="bg-gradient-to-br from-orange-500 to-orange-700 rounded-xl p-5 shadow-lg shadow-orange-500/20 text-white relative overflow-hidden group hover:shadow-orange-500/40 transition-shadow">
            <div class="flex justify-between items-start z-10 relative">
                <div>
                    <p class="text-white/80 text-sm font-medium mb-1 flex items-center gap-1">
                ...
                <div class="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center text-white group-hover:bg-white/30 transition-colors">
        ...
        <div class="bg-slate-800 rounded-xl p-5 border border-slate-700 shadow-lg relative overflow-hidden">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-slate-400 text-sm font-medium mb-1">Laba Bersih</p>
                    <h3 class="text-2xl font-bold {{ $totalProfit >= 0 ? 'text-emerald-400' : 'text-red-400' }}">{{ $totalProfit >= 0 ? '+' : '' }} Rp {{ number_format($totalProfit, 0, ',', '.') }}</h3>
                </div>
                <div class="w-10 h-10 rounded-lg bg-slate-700/50 flex items-center justify-center text-slate-300">
